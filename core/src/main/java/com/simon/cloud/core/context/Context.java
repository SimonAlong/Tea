package com.simon.cloud.core.context;

import com.simon.cloud.core.CfgManager;
import com.simon.cloud.core.CmdHandler;
...
public class Context {
    ...
    private String showCatalog = Constant.BASE_CATALOG;
    private String currentCatalog = Constant.BASE_CATALOG;
    private String currentModule = Constant.BASE_CATALOG;
    private String currentPath = Constant.MODULE_PATH;
    ...
    public String appendCatalog(String module) {
        if (!module.equals(Constant.SYS_MODULE)) {
